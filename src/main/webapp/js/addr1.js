function bindAddr(path){
	var pro=document.getElementById("Home_dialog_province");
	var city=document.getElementById("Home_dialog_city");
	var area=document.getElementById("Home_dialog_area");
